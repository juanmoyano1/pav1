...
Public Class lst_incidente_estado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "lst_incidente_estado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.lst_incidente_estado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_codEstado() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedlst_incidente_estado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lst_incidente_estado = New lst_incidente_estado()
        rpt.Site = Me.Site
        Return rpt
    End Function
