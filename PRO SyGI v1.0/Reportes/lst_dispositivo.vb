...
Public Class lst_dispositivo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.lst_dispositivo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_baja() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedlst_dispositivo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lst_dispositivo = New lst_dispositivo()
        rpt.Site = Me.Site
        Return rpt
    End Function
